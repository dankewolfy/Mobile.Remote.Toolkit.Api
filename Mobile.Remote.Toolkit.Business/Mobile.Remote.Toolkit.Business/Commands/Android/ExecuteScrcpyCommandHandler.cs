...
namespace Mobile.Remote.Toolkit.Business.Commands.Android
{
    ...
    /// </summary>
    public sealed class ExecuteScrcpyCommandHandler : AndroidBaseCommandHandler<ExecuteScrcpyCommandRequest, ProcessResultResponse>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public override async Task<ProcessResultResponse> Handle(ExecuteScrcpyCommandRequest request, CancellationToken cancellationToken)
