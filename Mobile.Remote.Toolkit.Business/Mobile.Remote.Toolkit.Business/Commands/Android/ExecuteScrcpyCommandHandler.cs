...
namespace Mobile.Remote.Toolkit.Business.Commands.Android
{
    ...
    /// </summary>
    public sealed class ExecuteScrcpyCommandHandler : AndroidBaseCommandHandler<ExecuteScrcpyRequest, ProcessResultResponse>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public override async Task<ProcessResultResponse> Handle(ExecuteScrcpyRequest request, CancellationToken cancellationToken)
