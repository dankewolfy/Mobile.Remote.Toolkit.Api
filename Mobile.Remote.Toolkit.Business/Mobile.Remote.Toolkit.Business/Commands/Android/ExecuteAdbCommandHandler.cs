...
namespace Mobile.Remote.Toolkit.Business.Commands.Android
{
    ...
    /// </summary>
    public sealed class ExecuteAdbCommandHandler : AndroidBaseCommandHandler<ExecuteAdbCommandRequest, ProcessResultResponse>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public override async Task<ProcessResultResponse> Handle(ExecuteAdbCommandRequest request, CancellationToken cancellationToken)
